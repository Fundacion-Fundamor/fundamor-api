...
const {adoptionValidationRules, validate, adoptionValidationUpdateRules } = require("../middleware/validator");
...
// update adoption
router.put("/", verify, adoptionValidationUpdateRules(), validate, adoptionsController.update);
